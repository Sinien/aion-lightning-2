...
public class Captor implements Runnable
{
    ...
    public void selectNetWorkInterface()
    {
        ...
        for (int i = 0; i < deviceCount; i++)
        {
            ...
            PacketSamurai.getUserInterface().log("Found Interface: "+niList[i].name);
    ...
    public void openDevice(NetworkInterface ni)
    {
        try
        {
            ...
            PacketSamurai.getUserInterface().log("Successfully opened device ("+ni.name+").");
        ...
        {
            PacketSamurai.getUserInterface().log("ERROR: Failed to open device ("+ni.name+") for capture "+ioe);
        }
    }
