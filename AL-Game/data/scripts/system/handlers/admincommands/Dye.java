...
/**
 * @author loleron
 * pieced together from DyeAction.java, Set.java
 */
...
public class Dye extends AdminCommand
{
	...
	public void executeCommand(Player admin, String[] params)
	{
		...
		else if (color.equalsIgnoreCase("true red")) { color = "c22626"; }			//169200005, 169201005, 169220001, 169230001, 169231001
		else if (color.equalsIgnoreCase("true white") || color.equalsIgnoreCase("white")) { color = "ffffff"; }	//169200006, 169201006, 169220002, 169231002
		else if (color.equalsIgnoreCase("black") || color.equalsIgnoreCase("true black")) { color = "000000"; }	//169200007, 169201007, 169230008, 169231008
		else if (color.equalsIgnoreCase("hot orange")) { color = "e36b00"; }		//169201008, 169220004, 169230009, 169231009
		else if (color.equalsIgnoreCase("rich purple")) { color = "440b9a"; }		//169201009, 169220005, 169230007, 169231003
		else if (color.equalsIgnoreCase("hot pink")) { color = "d60b7e"; }			//169201010, 169220006, 169230010, 169231010
		...
		else if (color.equalsIgnoreCase("olive green")) { color = "5f730e"; }		//169201013, 169220009, 169230005, 169231006
		else if (color.equalsIgnoreCase("deep blue")) { color = "14398b"; }			//169201014, 169220010, 169230006, 169231007
		else if (color.equalsIgnoreCase("romantic purple")) { color = "80185d"; }	//169230011
